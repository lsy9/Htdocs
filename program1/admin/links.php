            ...
            <form method="post">
                ...
                <div class="result-title">
                    <div class="result-list">
                        <a href="./links/show.php"><i class="icon-font"></i>已审核链接</a>
                    </div>
                </div>
                <div class="result-content">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php
                            ...
                            // 设置分页连接
                            $sql = "select count(id) num from shop_friendlink where status=0{$search_where}";
                            ...
                            // 获取所有未审核信息
                            $sql = "select * from shop_friendlink where status=0{$search_where} order by id desc limit {$pageOffset},{$pageSize}";
                            $result = mysqli_query($link,$sql);
                            if($result && mysqli_num_rows($result)>0){
                                // 循环输出所有
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="link-update" href="./links/doaction.php?act=show&id=<?php echo $row['id'];?>">审核</a>
                                <a class="link-del" href="./links/doaction.php?act=del&id=<?php echo $row['id']; ?>">删除</a>
                            </td>
                        </tr>
                        <?php
                                }
