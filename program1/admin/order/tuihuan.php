                ...
                <div class="result-content">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php
                            ...
                            // 设置分页连接
                            $sql = "select count(o.id) num from shop_order o,shop_order_status s where o.ordernum=s.ordernum and s.status=3 or s.status=4{$search_where}";
                            ...
                            $sql = "select o.id oid,o.ordernum,u.username,g.goodsname,s.id sid,s.status from shop_order o,shop_order_status s,shop_user u,shop_goods g where o.uid=u.id and o.gid=g.id and o.ordernum=s.ordernum and s.status in(3,4){$search_where} order by o.ordernum desc limit {$pageOffset},{$pageSize}";
                            $result = mysqli_query($link,$sql);
                            if($result && mysqli_num_rows($result)>0){
                                // 循环输出所有订单
                        ...
                        <tr>
                            ...
                            <?php
                                switch ($row['status']) {
                                    case 3: // 退货
                            ?>
                                <a href="./doaction.php?act=oktui&ordernum=<?php echo $row['ordernum']; ?>">确认退货</a> 
                                <a href="./doaction.php?act=notui&ordernum=<?php echo $row['ordernum']; ?>">取消退货</a>
                            <?php
                                    break;
                                    case 4: // 换货
                            ?>
                                <a href="./doaction.php?act=okhuan&ordernum=<?php echo $row['ordernum']; ?>">确认换货</a> 
                                <a href="./doaction.php?act=nohuan&ordernum=<?php echo $row['ordernum']; ?>">取消换货</a>
                            <?php
                                    break;
                                }
                            ?>
                    ...
                    <div class="list-page"> 
                        ...
                        <a href="./tuihuan.php?page=1<?php echo $search_url; ?>">首页</a>
                        <a href="./tuihuan.php?page=<?php echo $pagePrev,$search_url; ?>">上一页</a>
                        <a href="javascript:void(0);" class="current"><?php echo $page; ?></a>
                        <a href="./tuihuan.php?page=<?php echo $pageNext,$search_url; ?>">下一页</a>
                        <a href="./tuihuan.php?page=<?php echo $pageMax,$search_url; ?>">尾页</a>
                    </div>
                    <?php } ?>
                </div>
            </form>
