                ...
                <div class="result-content">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php
                            ...
                            // 设置分页连接
                            $sql = "select count(o.id) num from shop_order o,shop_order_status s where o.ordernum=s.ordernum and s.status=1{$search_where}";
                            ...
                            $sql = "select o.id oid,o.ordernum,u.username,g.goodsname,s.id sid from shop_order o,shop_order_status s,shop_user u,shop_goods g where o.uid=u.id and o.gid=g.id and o.ordernum=s.ordernum and s.status=1{$search_where} order by o.ordernum desc limit {$pageOffset},{$pageSize}";
                            $result = mysqli_query($link,$sql);
                            if($result && mysqli_num_rows($result)>0){
                                // 循环输出所有订单
                    ...
                    <div class="list-page"> 
                        ...
                        <a href="./wei.php?page=1<?php echo $search_url; ?>">首页</a>
                        <a href="./wei.php?page=<?php echo $pagePrev,$search_url; ?>">上一页</a>
                        <a href="javascript:void(0);" class="current"><?php echo $page; ?></a>
                        <a href="./wei.php?page=<?php echo $pageNext,$search_url; ?>">下一页</a>
                        <a href="./wei.php?page=<?php echo $pageMax,$search_url; ?>">尾页</a>
                    </div>
                    <?php } ?>
                </div>
            </form>
