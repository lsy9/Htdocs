...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../index.php">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="../goods.php">商品管理</a><span class="crumb-step">&gt;</span><span>商品回收站管理</span></div>
        </div>
        <!-- 搜索框 -->
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="search" id="">
                                    ...
                                    <option value="username" selected>商品名</option>
                                </select>
                            </td>
                            <th width="70">关键字:</th>
            ...
            <form name="myform" id="myform" method="post">
                ...
                <div class="result-title">
                    <div class="result-list">
                        <a href="./add.php"><i class="icon-font"></i>添加商品</a>
                ...
                <div class="result-content">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php
                            ...
                            // 设置分页连接
                            $sql = "select count(id) num from shop_goods where status=0 {$search_where}";
                            ...
                            // 获取所有商品信息
                            $sql = "select id,tid,goodsname,goodspic,goodsprice,goodsnum from shop_goods where status=0 {$search_where} limit {$pageOffset},{$pageSize}";
                            $result = mysqli_query($link,$sql);
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="link-del" href="./doaction.php?act=on&id=<?php echo $row['id']; ?>">上架</a>
                            </td>
                        </tr>
                        <?php
                                }
