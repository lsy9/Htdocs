            ...
            <form name="myform" id="myform" method="post">
                ...
                <div class="result-title">
                    <div class="result-list">
                        <a href="./user/add.php"><i class="icon-font"></i>添加用户</a>
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i>批量删除</a>
                        <a id="blackList" href="./user/blacklist.php"><i class="icon-font"></i>黑名单管理</a>
                    </div>
                </div>
                <div class="result-content">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php
                            ...
                            // 设置分页连接
                            $sql = "select count(u.id) num from shop_user u,shop_user_details d where u.id=d.uid{$search_where} and u.status=1";
                            ...
                            // 获取所有用户信息
                            $sql = "select u.id,u.username,u.nickname,u.userpic,u.level,d.gold,d.sex,d.email,d.lasttime from shop_user u,shop_user_details d where u.id=d.uid{$search_where} and u.status=1 limit {$pageOffset},{$pageSize}";
                            $result = mysqli_query($link,$sql);
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="link-update" href="./user/edit.php?id=<?php echo $row['id'];?>">修改</a>
                                <a class="link-del" href="./user/doaction.php?act=disable&id=<?php echo $row['id']; ?>">禁用</a>
                            </td>
                        </tr>
                        <?php
                                }
                    ...
                    <div class="list-page"> 
                        ...
                        <a href="./user.php?page=1<?php echo $search_url; ?>">首页</a>
                        <a href="./user.php?page=<?php echo $pagePrev,$search_url; ?>">上一页</a>
                        <a href="javascript:void(0);" class="current"><?php echo $page; ?></a>
                        <a href="./user.php?page=<?php echo $pageNext,$search_url; ?>">下一页</a>
                        <a href="./user.php?page=<?php echo $pageMax,$search_url; ?>">尾页</a>
                    </div>
                    <?php } ?>
                </div>
            </form>
