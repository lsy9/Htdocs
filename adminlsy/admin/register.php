...
<html>
    ...
    <body>
        <form action="doregister.php" method="post">
            <div id="head">
                <div >
                    <?php include('../public/home/config.php'); ?>
            ...
            <div id="body">
                ...
                <div id="zhutizuo">
                    ...
                    <div id="hang3">密&nbsp;码<span>*</span>&nbsp;&nbsp;<input type="password" name="password" size="35px"/></div>
                    <div id="hang4"><img src="./img/mimaqiangdu.jpg"></div>
                    <div id="hang5">确认密码<span>*</span>&nbsp;&nbsp;<input type="password" name="repasswd" size="35px"/></div>
                    <div id="hang6">电子邮箱<span>*</span>&nbsp;&nbsp;<input type="text" name="email" size="35px"/></div>
                    <div id="hang14">昵称&nbsp;&nbsp; <input type="text" name="name" size="35px"/></div>
                    <div id="hang7">QQ号码&nbsp;&nbsp; <input type="text" name="qq" size="35px"/></div>
                    <div id="hang8">现居住地<span>*</span>&nbsp;&nbsp;
                        <select name="sheng">
                            <option value="1">请选择</option>
								<option value="bjs">北京</option>
								<option value="jls">吉林省</option>
                        </select>
                        <select name="shi">
                            <option value="1">请选择</option>
                    ...
                    <div id="hang9">安全问题&nbsp;&nbsp;
                        <select name="question">
                            <option value="0">无安全问题</option>
                             <option value="1">你是谁？</option>
							 <option value="2">你在哪?</option>
						</select>
                    </div>
                    <div id="hang10">您的答案&nbsp;&nbsp;
                    ...
                    <div id="hang12">
                        <input type="img" name="yejiao" src="./img/yejiaozhuce.jpg" />
                    </div>
                </div>
                <div id="zhutiyou">
