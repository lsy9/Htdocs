...
<body>
	...
	<!--main_top-->
	<form method="post" action="./type_list.php">
			...
			<tr>
				<td align="left" valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						...
						<?php
							//遍历目录
							while($bianLi = mysqli_fetch_assoc($result)){
							//var_dump($bianLi);
						...
						<tr class="bggray">				
							...
							<td align="center" valign="middle" class="borderbottom">
								<a href="type_updateFQ.php?id=<?php echo $bianLi['id']?>" target="mainFrame" onFocus="this.blur()" class="add">修改</a><!---->
								<span class="gray">&nbsp;|&nbsp;</span>
								<a href="./type_tjzbk.php?pid=<?php echo $bianLi['id'] ?>" target="mainFrame" onFocus="this.blur()" class="add">添加子版块</a>
								<span class="gray">&nbsp;|&nbsp;</span>
								<a href="./type_delFQ.php?id=<?php echo $bianLi['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
							</td>
						</tr>
						<?php	 
							}else{
						...
						<tr>
							...
							<td align="left" valign="middle" class="borderright borderbottom tdb"><?php echo $bianLi['name'] ?></td>
							<td align="center" valign="middle" class="borderbottom">
								<a href="./type_update.php?id=<?php echo $bianLi['id']?>" target="mainFrame" onFocus="this.blur()" class="add">修改</a>
								<span class="gray">&nbsp;|&nbsp;</span>
								<a href="./type_look.php?id=<?php echo $bianLi['id']?>" target="mainFrame" onFocus="this.blur()" class="add">查看贴子</a>
								<span class="gray">&nbsp;|&nbsp;</span>
								<a href="./type_del.php?id=<?php echo $bianLi['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
							</td>
						</tr>
						<?php
									}
