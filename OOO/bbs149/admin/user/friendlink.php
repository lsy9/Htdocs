...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：友情链接浏览</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="friendlinkadd.php" target="mainFrame" onFocus="this.blur()" class="add">新增友情链接</a></td>
  		</tr>
	</table>
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
		...
		<th align="center" valign="middle" class="borderright">logo预览</th>
	...
	if($result && mysqli_num_rows($result)>0){
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		...
		<td align='center' valign="middle" class="borderright borderbottom"><image src='../../public/uploads/<?php echo $rows['logo'];?>' width='20' height='20'></td>
        <td align="center" valign="middle" class="borderbottom">
		<a href="./friendlinkupdate.php?linkname=<?php echo $linkname;?>&id=<?php echo $id ;?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
		<span class="gray">&nbsp;|&nbsp;</span>
		<a href="./doaction.php?a=delectfriendlink&id=<?php echo $id;?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
