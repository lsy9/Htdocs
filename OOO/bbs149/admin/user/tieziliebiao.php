...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="get" action="tieziliebiao.php">
	         <span>主题：</span>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
		...
		<th align="center" valign="middle" class="borderright">是否加精</th>
	  ...
	  <?php
			...
			//求得总数据条数
			$sql = "select * from post where recycle='0'".$where;
			...
			//4.定义sql语句，发送并执行
			$sql = "select * from post where recycle='0'".$where.$limit;
			$result = mysqli_query($link,$sql);
			
			//5.解析结果集
			if($result && mysqli_num_rows($result)){
				while($rows = mysqli_fetch_assoc($result)){
				$time = date("Y-m-d H:i:s",$rows['ctime']);
	 ...
	 ?>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo $rows['top']==1?"置顶":"普通"?></td>
		<td align="center" valign="middle" class="borderright borderbottom"><?php echo $rows['elite']==1?"加精":"普通"?></td>
        <td align="center" valign="middle" class="borderbottom">
		<a href="lookpost.php?id=<?php echo $rows['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">查看帖子</a><span class="gray">&nbsp;|&nbsp;</span>
		<a href="updatepost.php?a=updatepost&id=<?php echo $rows['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
		<a href="doaction.php?a=putpost&id=<?php echo $rows['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">放入回收站</a><span class="gray">&nbsp;|&nbsp;</span>
		<a href="doaction.php?a=zhiding&id=<?php echo $rows['id'];?>&top=<?php echo $rows['top'];?>" target="mainFrame" onFocus="this.blur()" class="add"><?php echo $rows['top']==1?"取消置顶":"置顶";?></a><span class="gray">&nbsp;|&nbsp;</span>
		<a href="doaction.php?a=jiajing&id=<?php echo $rows['id'];?>&elite=<?php echo $rows['elite'];?>" target="mainFrame" onFocus="this.blur()" class="add"><?php echo $rows['elite']==1?"取消加精":"加精";?></a><span class="gray">&nbsp;|&nbsp;</span>
		<a href="checkpost.php?id=<?php echo $rows['id'];?>" target="mainFrame" onFocus="this.blur()" class="add">管理回复</a><span class="gray">&nbsp;&nbsp;</span></td>
      </tr>
	<?php
  ...
  <tr>
	...
	<?php
		...
		echo "<a href='./tieziliebiao.php?p=1{$url}'>首页</a>&nbsp;";
		echo "<a href='./tieziliebiao.php?p=".($page-1)."{$url}'>上一页</a>&nbsp;";
		echo "<a href='./tieziliebiao.php?p=".($page+1)."{$url}'>下一页</a>&nbsp;";
		echo "<a href='./tieziliebiao.php?p={$maxPage}{$url}'>末页</a>";
	?>
	</td>
  </tr>
</table>
