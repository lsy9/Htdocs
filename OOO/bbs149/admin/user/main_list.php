...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
	...
	?>
	 <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo $rows['auth']=='1'?"超级管理员":"普通用户";?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo $rows['status']=='1'?"开启":"禁用";?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo date("Y-m-d H:i:s",$rows['lastlogin']);?></td>
        <td align="center" valign="middle" class="borderbottom">
		<a href="updateuser.php?id=<?php echo $rows['id']?>&name=<?php echo $rows['userName']?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
		<a href="doaction.php?a=delete&id=<?php echo $rows['id']?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a><span class="gray">&nbsp;|&nbsp;</span>
		<a href="doaction.php?a=idout&id=<?php echo $rows['id']?>" target="mainFrame" onFocus="this.blur()" class="add">禁用</a><span class="gray">&nbsp;|&nbsp;</span>
		<a href="doaction.php?a=idin&id=<?php echo $rows['id']?>" target="mainFrame" onFocus="this.blur()" class="add">解禁</a></td>
      </tr>
	<?php
			}
		}
  ...
  <tr>
    <td align="left" valign="top" class="fenye">
		...
		echo "<a href='./main_list.php?p=1{$url}'>首页</a>&nbsp;";
		echo "<a href='./main_list.php?p=".($page-1)."{$url}'>上一页</a>&nbsp;";
		echo "<a href='./main_list.php?p=".($page+1)."{$url}'>下一页</a>&nbsp;";
		echo "<a href='./main_list.php?p={$maxPage}{$url}'>末页</a>";
	?>
	</td>
  </tr>
</table>
