...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：友情链接管理&nbsp;&nbsp;>&nbsp;&nbsp;编辑友情链接</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="./friend_list.php" target="mainFrame" onFocus="this.blur()" class="add">编辑友情链接</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="./doaction.php?a=friendlinkupdate&id=<?php echo $_GET['id'] ;?>" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">链接名称：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="linkname" value="<?php echo $_GET['linkname'];?>" class="text-word">
        </td>
        </tr>   
		
		 <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		<td align="right" valign="middle" class="borderright borderbottom bggray">友情链接LOGO：</td>
		<td align="left" valign="middle" class="borderright borderbottom main-for">
		<input type="file" name="ulogo" value="" class="text-word">
		</td>
	 </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
