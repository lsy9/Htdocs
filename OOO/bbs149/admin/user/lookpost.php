...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：帖子列表&nbsp;&nbsp;>&nbsp;&nbsp;查看帖子</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">查看帖子</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form action="doaction.php?a=updatepost" method="post" enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">标题</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
			
		<input type="text" name="title" value="<?php echo $row['title'];?>" readonly style="width:270px;height:40px;"/>			
	...
	<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		...
		<input type="text" name="uid" value="<?php echo $row1['userName'];?>" readonly style="width:270px;height:40px;"/>			
	  ...
	  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		...
		<input type="textarea" name="content" readonly style="width:500px;height:400px;" value="<?php echo $row['content'];?>"/>			
