...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a href="friend_add.php" target="mainFrame" onFocus="this.blur()" class="add">添加友情链接</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="./doaction.php?a=friendlinkadd" enctype="multipart/form-data">
