...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：板块管理&nbsp;&nbsp;>&nbsp;&nbsp;添加父分区</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">新父分区</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form action="doaction.php?a=addFather" method="post">
